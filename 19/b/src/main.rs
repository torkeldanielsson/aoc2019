    ...
    while !fits {
        ...
        loop {
            ...
            if program.return_state == ReturnState::ProducedOutput {
                if program.outputs.last().unwrap() == &1 {
                    break;
                }
            } else {
        ...
        {
            let left_lower_x = x - side + 1;
            let left_lower_y = y + side - 1;
            ...
            program.inputs.push(left_lower_x);
            program.inputs.push(left_lower_y);
